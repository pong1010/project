...
<!-- css & js -->    
	...
	<link rel="stylesheet" type="text/css" href="/resources/willfun/css/datepickerCustom.css">   
 	<link rel="stylesheet" type="text/css" href="/resources/willfun/css/custom-tinymce.min.css">   
...
<body class="main">
	...
	<link rel="stylesheet" href="//image-se.ycrowdy.com/crowdyCss/slick.min.css?v=20200515_001">
				...
				<div class="container">
					...
					<div id="navbar" class="navbar-collapse collapse">
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a><sec:authentication property="principal.member.mem_name"/>님</a></li>
							<li><div class="gnb_card_background"><a href="#" class="dropdown-toggle open_my_card">
								마이페이지</a></div></li>
...
<sec:authorize access="isAuthenticated()">
				<div id="myPage" class="gnb_card" style="display: none;" >
					<div class="gnb_card_frame">
						<div class="gnb_card_header">
							<div class="gnb_card_header_table">
								<div class="gnb_card_header_table_cell">
									<a href="javascript:void(0)" class="gnb_card_close" style="background-image: url('/resources/willfun/img/close.png');">창닫기</a>
									<div class="user_photo">
										<!---->
									</div>
									<div class="user_name"><sec:authentication property="principal.member.mem_name"/></div>
									<div class="user_email"><sec:authentication property="principal.username"/></div>
								</div>
							</div>
						</div>
						<div class="gnb_card_body">
							<ul>
								...
								<li><a href="/member/myPage">설정</a></li>
